...
export function WorkflowCompletedTemplate({ documentTitle }: TProps) {
    return (
        <Html>
            <Head />
                ...
                <Body className="max-w-2xl mx-auto p-6 bg-slate-50">
                    ...
                    <Section className="text-center mb-8">
                        <Text className="text-gray-600">
                            Маршрут согласования документа {`"${documentTitle}"`} завершен. Все участники
                            подтвердили/подписали документ.
                        </Text>
                    </Section>
