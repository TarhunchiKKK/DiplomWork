...
export function CommentUpdatedTemplate({ creatorUsername, documentTitle }: TProps) {
    return (
        <Html>
            <Head />

            <Preview>Изменен комментарий</Preview>
                ...
                <Body className="max-w-2xl mx-auto p-6 bg-slate-50">
                    ...
                    <Section className="text-center mb-8">
                        <Text className="text-gray-600">
                            Пользователь {creatorUsername} изменил комментарий к вашему документу {`"${documentTitle}"`}
                            .
                        </Text>
                    </Section>
